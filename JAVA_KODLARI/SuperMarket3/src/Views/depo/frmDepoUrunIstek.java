...
public class frmDepoUrunIstek extends javax.swing.JFrame {

  
  DefaultTableModel model;
    List<UrunIstek> urunList = new ArrayList<>();
    UrunIstekDAL islemler = new UrunIstekDAL();
    public frmDepoUrunIstek() {
    ...
    private void initComponents() {
        ...
        LsefOnay = new javax.swing.JLabel();
        ...
        IDepo = new javax.swing.JComboBox<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("ÜRÜN İSTEK");
        setLocation(new java.awt.Point(300, 110));
        setResizable(false);
        ...
        LsefOnay.setFont(new java.awt.Font("Comic Sans MS", 1, 12)); // NOI18N
        LsefOnay.setForeground(new java.awt.Color(255, 255, 255));
        LsefOnay.setText("sef erisebilir");
        ...
        IDepo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "sipariş verildi", "siparis verilmedi" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(IDepo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(LsefOnay, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jLabel4)
                    .addComponent(lpersonelNo, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
...
public void TabloGetir() {
    ...
    public void urunGuncelle() {
        ...
        istek.setDepodurum(IDepo.getSelectedItem().toString());
        ...
        istek.setSefOnay(LsefOnay.getText());
    ...
    private void TabloMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabloMouseClicked
        ...
        LsefOnay.setText(model.getValueAt(selectedrow, 7).toString());
        IDepo.setSelectedItem(model.getValueAt(selectedrow, 8).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDepoUrunIstek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDepoUrunIstek().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> IDepo;
    ...
    private javax.swing.JLabel LsefOnay;
